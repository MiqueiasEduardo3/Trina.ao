...
const ShopDataCard = ({ img, nomeProduto, percentagem, detalhesProduto1, detalhesProduto2, tamanhos, precoAnterior, precoActual }) => {
  ...
  return (
    <div className="shadow-lg rounded-lg dark:text-white bg-white cursor-pointer relative mb-10 md:mb-2">
    <FontAwesomeIcon
    ...
    <div className="overflow-hidden flex-col relative">
      <img
        src={img}
        alt="No image"
        className="mx-auto h-[300px] w-[360px] md:h-[220px] md:w-[290px] lg:h-[320px] lg:w-[320px] sm:transition sm:duration-700 sm:hover:skew-x-2 sm:hover:scale-110"
      />
    ...
    <div className="space-y-2 p-3 bg-white">
      ...
      <h1 className="line-clamp-1 text-xs text-zinc-600">{detalhesProduto1}</h1>
      <div className="flex items-center justify-between border-t-2 py-3 mt-3">
        ...
        <span
          ...
          className="cursor-pointer py-2 px-7 md:py-2 mg:px-5 lg:py-2 lg:px-8 bg-black text-xs md:text-sm lg:text-sm
