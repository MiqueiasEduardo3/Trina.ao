...
const Footer = () =>{
    return(
        <>
        <section className='footer w-full h-[150vh] md:h-[40vh] lg:h-[65vh] justify-center flex items-center  bg-zinc-50 '>
            <div className="w-11/12 items-center flex-col justify-center">
                ...
                <div className="w-full h-[15vh] md:h-[6vh] lg:h-[10vh] mt-[520px] md:mt-0 lg:mt-0 flex-col items-center justify-center gap-4">

                    <h1 className='my-3 text-center text-sm'>Pagamentos seguros</h1>
