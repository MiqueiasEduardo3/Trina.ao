    ...
    return(
        ...
        <div className="flex items-center mt-28 mb-10 h-5/6 p-2 ">
            <div className="w-11/12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-14 md:gap-8 lg:gap-2">
                ...
                <div className="w-full h-full items-center justify-center gap-4 flex bg-zinc-100 p-2">
                    <div className="flex-col w-5/12 h-full">
                ...
                <div className="w-full -ml-3 md:ml-5 lg:ml-5 p-4 items-center h-full justify-center flex-col rounded-sm">
                    <h1 className="text-3xl font-bold">{nomeProduto}</h1>

                    <div className="w-full mt-5">
                     <p className="text-sm">{detalhesProduto2}</p>
                    </div>

                    <div className="w-full mt-10 flex-col gap-2">
                        <span className="text-lg font-bold">Tamanhos :
                        <span className="font-normal"> {tamanhos}</span>
                        </span>

                        <h1 className="text-lg font-bold">Cores : 
                        <div className="w-2/5 flex gap-2 -ml-1 md:-ml-12 lg:ml-10 -mt-6">
                            {colors.map((color) => (
                                <button
                                key={color.name}
                    ...
                    <div className="mt-10">
                        ...
                        <div className="flex items-center justify-between mb-4 w-1/2 md:w-2/6 lg:w-2/6">
                        ...
                        <div className="w-2/12 flex items-center ml-3 md:ml-0 lg:ml-0 justify-center mb-6">
       ...
       <section className="w-full mt-20 mb-20">
            ...
            <section className="flex items-center justify-center my-6">   
                <div className=" w-2/3 md:w-11/12 lg:w-11/12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-14 md:gap-8 lg:gap-4">
